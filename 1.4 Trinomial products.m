...
Int[1/(a_+b_.*x_^n_+c_.*x_^n2_),x_Symbol] :=
  ...
  1/(2*c*q*r)*Int[(r+x^(n/2))/(q+r*x^(n/2)+x^n),x]]] /;
FreeQ[{a,b,c},x] && ZeroQ[n2-2*n] && NonzeroQ[b^2-4*a*c] && PositiveIntegerQ[n/2] && NegQ[b^2-4*a*c]
...
Int[x_^m_./(a_+b_.*x_^n_+c_.*x_^n2_.),x_Symbol] :=
  ...
  1/(2*c*r)*Int[x^(m-3*(n/2))*(q-r*x^(n/2))/(q-r*x^(n/2)+x^n),x]]] /;
FreeQ[{a,b,c},x] && ZeroQ[n2-2*n] && NonzeroQ[b^2-4*a*c] && PositiveIntegerQ[n/2,m] && 3*n/2<=m<2*n && NegQ[b^2-4*a*c]
...
Int[x_^m_./(a_+b_.*x_^n_+c_.*x_^n2_.),x_Symbol] :=
  ...
  1/(2*c*r)*Int[x^(m-n/2)/(q+r*x^(n/2)+x^n),x]]] /;
FreeQ[{a,b,c},x] && ZeroQ[n2-2*n] && NonzeroQ[b^2-4*a*c] && PositiveIntegerQ[n/2,m] && n/2<=m<3*n/2 && NegQ[b^2-4*a*c]
...
FreeQ[{a,c,d,e},x] && ZeroQ[n2-2*n] && ZeroQ[c*d^2-a*e^2] && PositiveIntegerQ[n/2] && PosQ[d*e]
...
Int[(d_+e_.*x_^n_)/(a_+c_.*x_^n2_),x_Symbol] :=
  ...
  d/(2*a)*Int[(d+q*x^(n/2))/(d+q*x^(n/2)-e*x^n),x]] /;
FreeQ[{a,c,d,e},x] && ZeroQ[n2-2*n] && ZeroQ[c*d^2-a*e^2] && PositiveIntegerQ[n/2] && NegQ[d*e]
...
Int[(d_+e_.*x_^n_)/(a_+c_.*x_^n2_),x_Symbol] :=
  ...
  1/(2*Sqrt[2]*c*q^3)*Int[(Sqrt[2]*d*q+(d-e*q^2)*x^(n/2))/(q^2+Sqrt[2]*q*x^(n/2)+x^n),x]] /;
FreeQ[{a,c,d,e},x] && ZeroQ[n2-2*n] && NonzeroQ[c*d^2+a*e^2] && NonzeroQ[c*d^2-a*e^2] && PositiveIntegerQ[n/2] && PosQ[a*c]
...
FreeQ[{a,c,d,e,n},x] && ZeroQ[n2-2*n] && NonzeroQ[c*d^2+a*e^2] && NegQ[a*c] && IntegerQ[n]


Int[(d_+e_.*x_^n_)/(a_+c_.*x_^n2_),x_Symbol] :=
  d*Int[1/(a+c*x^(2*n)),x] + e*Int[x^n/(a+c*x^(2*n)),x] /;
FreeQ[{a,c,d,e,n},x] && ZeroQ[n2-2*n] && NonzeroQ[c*d^2+a*e^2] && (PosQ[a*c] || Not[IntegerQ[n]])


Int[(d_+e_.*x_^n_)/(a_+b_.*x_^n_+c_.*x_^n2_),x_Symbol] :=
  With[{q=Rt[2*d/e-b/c,2]},
  e^2/(2*c)*Int[1/(d+e*q*x^(n/2)+e*x^n),x] + e^2/(2*c)*Int[1/(d-e*q*x^(n/2)+e*x^n),x]] /;
FreeQ[{a,b,c,d,e},x] && ZeroQ[n2-2*n] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-a*e^2] && PositiveIntegerQ[n/2] && 
  (PositiveQ[2*d/e-b/c] || Not[NegativeQ[2*d/e-b/c]] && ZeroQ[d-e*Rt[a/c,2]])


Int[(d_+e_.*x_^n_)/(a_+b_.*x_^n_+c_.*x_^n2_),x_Symbol] :=
  With[{q=Rt[b^2-4*a*c,2]},
  (e/2+(2*c*d-b*e)/(2*q))*Int[1/(b/2-q/2+c*x^n),x] + (e/2-(2*c*d-b*e)/(2*q))*Int[1/(b/2+q/2+c*x^n),x]] /;
FreeQ[{a,b,c,d,e,n},x] && ZeroQ[n2-2*n] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-a*e^2] && PositiveIntegerQ[n/2] && 
  PositiveQ[b^2-4*a*c]
