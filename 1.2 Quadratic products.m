...
FreeQ[{a,b,c,d,e,f},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && ZeroQ[c*e-b*f]
...
FreeQ[{a,b,c,d,e,f},x] && RationalQ[a,b,c,d,e,f] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && NonzeroQ[c*e-b*f] && NegativeQ[b^2-4*a*c] *)
...
FreeQ[{a,c,d,e,f},x] && RationalQ[a,c,d,e,f] && NonzeroQ[e^2-4*d*f] && NegativeQ[-a*c] *)
...
FreeQ[{a,b,c,d,f},x] && RationalQ[a,b,c,d,f] && NonzeroQ[b^2-4*a*c] && NegativeQ[b^2-4*a*c] *)
...
Int[1/((a_+b_.*x_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  2*c/q*Int[1/((b+q+2*c*x)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,b,c,d,e,f},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && NonzeroQ[c*e-b*f] && PosQ[b^2-4*a*c]


Int[1/((a_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  1/2*Int[1/((a-Rt[-a*c,2]*x)*Sqrt[d+e*x+f*x^2]),x] +
  1/2*Int[1/((a+Rt[-a*c,2]*x)*Sqrt[d+e*x+f*x^2]),x] /;
FreeQ[{a,c,d,e,f},x] && NonzeroQ[e^2-4*d*f] && PosQ[-a*c]
...
Int[1/((a_+b_.*x_+c_.*x_^2)*Sqrt[d_+f_.*x_^2]),x_Symbol] :=
  ...
  2*c/q*Int[1/((b+q+2*c*x)*Sqrt[d+f*x^2]),x]] /;
FreeQ[{a,b,c,d,f},x] && NonzeroQ[b^2-4*a*c] && PosQ[b^2-4*a*c]
...
Int[1/((a_.+b_.*x_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[(c*d-a*f-q+(c*e-b*f)*x)/((a+b*x+c*x^2)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,b,c,d,e,f},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && NonzeroQ[c*e-b*f] && NegQ[b^2-4*a*c]
...
Int[1/((a_.+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[(c*d-a*f-q+c*e*x)/((a+c*x^2)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,c,d,e,f},x] && NonzeroQ[e^2-4*d*f] && NegQ[-a*c]
...
Int[1/((a_.+b_.*x_+c_.*x_^2)*Sqrt[d_.+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[(c*d-a*f-q+(-b*f)*x)/((a+b*x+c*x^2)*Sqrt[d+f*x^2]),x]] /;
FreeQ[{a,b,c,d,f},x] && NonzeroQ[b^2-4*a*c] && NegQ[b^2-4*a*c]
...
FreeQ[{a,b,c,d,e,f},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && ZeroQ[b*d-a*e]
...
Int[(g_.+h_.*x_)/((a_+b_.*x_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  (2*c*g-h*(b+q))/q*Int[1/((b+q+2*c*x)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,b,c,d,e,f,g,h},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && PosQ[b^2-4*a*c]
...
Int[(g_.+h_.*x_)/((a_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  (h/2-c*g/(2*q))*Int[1/((q+c*x)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,c,d,e,f,g,h},x] && NonzeroQ[e^2-4*d*f] && PosQ[-a*c]
...
Int[(g_.+h_.*x_)/((a_+b_.*x_+c_.*x_^2)*Sqrt[d_+f_.*x_^2]),x_Symbol] :=
  ...
  (2*c*g-h*(b+q))/q*Int[1/((b+q+2*c*x)*Sqrt[d+f*x^2]),x]] /;
FreeQ[{a,b,c,d,f,g,h},x] && NonzeroQ[b^2-4*a*c] && PosQ[b^2-4*a*c]
...
Int[(g_.+h_.*x_)/((a_.+b_.*x_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[Simp[h*(b*d-a*e)-g*(c*d-a*f+q)-(g*(c*e-b*f)-h*(c*d-a*f-q))*x,x]/((a+b*x+c*x^2)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,b,c,d,e,f,g,h},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[e^2-4*d*f] && NonzeroQ[b*d-a*e] && NegQ[b^2-4*a*c]
...
Int[(g_.+h_.*x_)/((a_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[Simp[-a*h*e-g*(c*d-a*f+q)+(h*(c*d-a*f-q)-g*c*e)*x,x]/((a+c*x^2)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,c,d,e,f,g,h},x] && NonzeroQ[e^2-4*d*f] && NegQ[-a*c]
...
Int[(g_.+h_.*x_)/((a_.+b_.*x_+c_.*x_^2)*Sqrt[d_+f_.*x_^2]),x_Symbol] :=
  ...
  1/(2*q)*Int[Simp[h*b*d-g*(c*d-a*f+q)+(h*(c*d-a*f-q)+g*b*f)*x,x]/((a+b*x+c*x^2)*Sqrt[d+f*x^2]),x]] /;
FreeQ[{a,b,c,d,f,g,h},x] && NonzeroQ[b^2-4*a*c] && NegQ[b^2-4*a*c]
